  ...
  return (
    <div className="px-6 py-8 pb-24 lg:pb-8 max-w-5xl">
      ...
      <div className="mb-5 flex items-start justify-between gap-4">
        ...
        >
          {generating ? (
            <><span className="w-3.5 h-3.5 border-2 border-canvas/30 border-t-canvas rounded-full animate-spin" />Building...</>
      ...
      <div className="bg-card border border-border rounded-2xl p-4 mb-6">
        <div className="flex items-center justify-between gap-3 mb-3">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              {geoLocating
                ? <span className="w-3 h-3 border border-canvas/30 border-t-canvas rounded-full animate-spin inline-block" />
            ...
            >
              {loadingStores && !geoLocating ? (
                <span className="w-3 h-3 border border-text-muted border-t-text-primary rounded-full animate-spin inline-block" />
              ) : "Go"}
            </button>
          </div>
        </div>
        ...
        {loadingStores && (
          <div className="flex items-center gap-3 py-3 text-text-muted text-sm">
            <span className="w-4 h-4 border-2 border-border border-t-lime rounded-full animate-spin" />
