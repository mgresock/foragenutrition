    ...
    <div className="relative min-h-screen bg-canvas overflow-hidden flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex lg:w-[55%] relative flex-col justify-between p-14 overflow-hidden">
        ...
        >
          <defs>
            <pattern id="contour" x="0" y="0" width="120" height="120" patternUnits="userSpaceOnUse">
              <ellipse cx="60" cy="60" rx="55" ry="40" fill="none" stroke="#b6f040" strokeWidth="0.6" />
              <ellipse cx="60" cy="60" rx="42" ry="28" fill="none" stroke="#b6f040" strokeWidth="0.6" />
              <ellipse cx="60" cy="60" rx="29" ry="17" fill="none" stroke="#b6f040" strokeWidth="0.6" />
              <ellipse cx="60" cy="60" rx="16" ry="8" fill="none" stroke="#b6f040" strokeWidth="0.6" />
            </pattern>
          </defs>
        ...
        <div
          ...
          style={{ background: "radial-gradient(circle, rgba(182,240,64,0.06) 0%, transparent 65%)" }}
        />
